...
cfg = {ip="192.168.11.xx",netmask="255.255.255.0",gateway="192.168.11.1"};  -- IP number for your ESP and gateway.  Use a static number and reserve it in your router. 
